...
public class MeteorNode : MonoBehaviour
{
    ...
    private readonly float[] meteorFinalX = {0, 1f, 1.1f, 0.57f, 0.57f, 0.7f, 0.83f, 0.81f, 1.07f};
	private readonly float[] meteorFinalY = {0, 0.42f, 0.42f, 0.5f, 0.5f, 0.5f, 0.47f, 0.67f, 1.05f};
	private readonly float[] explosionXOffset = {0, 0.1f, 0.2f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.2f};
	private readonly float[] explosionYOffset = {0, 0f, 0f, 0f, 0.1f, 0f, 0.1f, -0.1f, 0.2f};
